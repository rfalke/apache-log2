...
apache_log.data = new Obj()


apache_log.data.options({ // The configuration settings constructor
    format: ['combined', 'common'], // Fi3rst index will be the defualt (will be "undefined" for empty arrays)
    directory: ['/var/log/'], // Empty array will allow for any setting type to be placed here
    filename: ['access.log'],
})
